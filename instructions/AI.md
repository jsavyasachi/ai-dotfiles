...
- 2026-07-21: a dependency bump on a wrapper library is a **parity audit**, not just a green build: bump, audit the compare range for newly added *stable* surface, implement it (skip beta/preview/deprecated), and ship bump + features in one release. Audit **before** tagging, since Clojars is immutable
